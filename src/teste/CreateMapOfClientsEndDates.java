...
public class CreateMapOfClientsEndDates {

    private static CreateMapOfClientsEndDates createMapOfClientsEndDates;
    ...
    private CreateMapOfClientsEndDates() {
    }

    public static CreateMapOfClientsEndDates getInstance() {
        if (createMapOfClientsEndDates == null) {
            createMapOfClientsEndDates = new CreateMapOfClientsEndDates();
        }
        return createMapOfClientsEndDates;
    }
    
    public Map<String, Set<LocalDate>> createMap(List<String> string) {        
